...
<html>
	...
	<head>
		...
		<link onerror="wx_loaderror(this)" rel="stylesheet" href="<%=basePath%>css/advanced_reply_common.css">
		<link onerror="wx_loaderror(this)" rel="stylesheet" href="<%=basePath%>css/advanced_reply_keywords.css">
		<link rel="stylesheet" href="<%=basePath%>css/conan.css" />
		<link rel="stylesheet" type="text/css" href="<%=basePath%>css/akr.css" />
		<script type="text/javascript" src="<%=basePath%>js/jq.min.js"></script>
		<script type="text/javascript" src="<%=basePath%>js/set_key.js" ></script>
	</head>
					...
					<div class="main_bd">
						...
						<div class="content_wrap" id="div_replyContent">
							...
							<div class="btn_wrp">
								...
								<a href="javascript:void(0);" class="btn btn_add btn_primary" id="Js_rule_add" data-status="not"><i class="icon14_common add_white"></i>查看规则</a>
							</div>
