...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>js/set_key2.js" ></script>
	</head>
					...
					<div class="main_bd">
						...
						<div class="content_wrap" id="div_replyContent">
							...
							<div class="btn_wrp">
								...
								<a href="javascript:void(0);" class="btn btn_add btn_primary" id="Js_rule_add" data-status="not">查看规则</a>
							</div>
