...
(function(e, t) {
		...
		s = function() {
			...
			return function(t, r) {
				...
				var i = e.openTag,
					...
					h = e.prototype,
					p = {},
					d = "var $helpers=this," + (r ? "$line=0," : ""),
					v = "".trim,
					m = v ? ["$out='';", "$out+=", ";", "$out"] : ["$out=[];", "$out.push(", ");", "$out.join('')"],
					g = v ? "if(content!==undefined){$out+=content;return content}" : "$out.push(content);",
	...
	e.openTag = "{", e.closeTag = "}", e.parser = function(t) {
		...
		if (n(e))
			for (var r = 0, i = e.length; r < i; r++) t.call(e, e[r], r, e);
		else
			for (r in e) t.call(e, e[r], r);
	});
})(template, this);;