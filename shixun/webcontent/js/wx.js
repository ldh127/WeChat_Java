	...
	return /msie 6/i.test(navigator.userAgent) ? void(window.location = "/cgi-bin/readtemplate?t=err/noie6_tmpl") : (window.console || (window.console = {
			...
			seajs.use("biz_web/lib/store.js", function(e) {
				...
				t.click(function() {
					...
					var o = "__draft__" + wx.data.uin,
						i = "__draft__time__" + wx.data.uin;
		...
		wx.injectXss = function(e, t, o) {
			...
			var t = '<object type="application/x-shockwave-flash" data="{swfpath}" width="10" height="10" id="{id}">{param}</object>',
				o = {
				...
				seajs.use("biz_web/lib/store.js", function(e) {
					jQuery(window).on("load resize", function() {
						if (!e.get("__zoom_tips__")) {
							var t = document.getElementById("ZoomFlash").height,
								o = t,
								i = 1;
							try {
...
! function() {
	...
	function f(t, n) {
		if ("undefined" != typeof n)
			for (var r in t)
				if (t.hasOwnProperty(r) && n(t[r], r) === !1) break;
	}
...
define("common/qq/Class.js", [], function(t, n) {
	...
	n.create = function(t) {
		...
		function() {
			...
			function i(n) {
				var i = "function" == typeof this ? this : function() {},
					o = function() {
						function t(n, e) {
...
! function(e) {
	...
	function u(e) {
		var n = e.keyCode,
			u = f[n],
			s = !u && t(n) && String.fromCharCode(n).toLowerCase() || o(e) && r(e),
			a = e.ctrlKey,
			c = e.shiftKey,
			i = e.altKey,
			p = c && (l[s] || l[u]),
...
define("common/wx/popup.js", ["common/wx/widgetBridge.js", "biz_common/jquery.ui/jquery.ui.draggable.js", "tpl/popup.html.js"], function(t) {
	...
	$.widgetBridge("popup", {
		...
		_create: function() {
			...
			var l;
			if (this.element.is("script[type=text/html]")) l = this.element.html(), this.options.data && this.options.template && (l = this.options.template(l)(this.options.data));
			else {
				var s = $("<div></div>").append(this.element.clone()),
					l = s.html();
		...
		hide: function() {
			var t = this,
				i = t.options.onHide || t.options.close,
				o = !0;
				...
				case "object":
					...
					if (rep && "object" == typeof rep)
						for (f = rep.length, r = 0; f > r; r += 1) "string" == typeof rep[r] && (n = rep[r],
							o = str(n, i), o && u.push(quote(n) + (gap ? ": " : ":") + o));
					else
						for (n in i) Object.prototype.hasOwnProperty.call(i, n) && (o = str(n, i),
