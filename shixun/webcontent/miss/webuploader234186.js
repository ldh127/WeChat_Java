...
var t=e("biz_web/lib/webuploader/base.js"),r=e("biz_web/lib/webuploader/runtime/flash/runtime.js"),n=e("biz_web/lib/webuploader/runtime/client.js"),s=t.$;
return r.register("Transport",{
init:function(){
this._status=0,this._response=null,this._responseJson=null;
},
send:function(){
var e,t=this.owner,r=this.options,n=this._initAjax(),o=t._blob,i=r.server;
...
var e,a=this._blob,r=this.options;
...
var h,l,c,g,d,u,m,b=i.naturalWidth,_=i.naturalHeight,f=e.getContext("2d"),w=a(i),v="image/jpeg"===this.type,p=1024,A=0,I=0;
...
var t=e("biz_web/lib/webuploader/base.js"),r=e("biz_web/lib/webuploader/runtime/html5/runtime.js"),n=t.noop,s=t.$;
return r.register("Transport",{
init:function(){
this._status=0,this._response=null;
},
send:function(){
var e,r,n,a=this.owner,o=this.options,i=this._initAjax(),u=a._blob,d=o.server;
...
_parse:function(e,r){
if(!(e.byteLength<6)){
var a,n,i,u,s=new DataView(e),l=2,o=s.byteLength-4,b=l,g={};
if(65496===s.getUint16(0)){
for(;o>l&&(a=s.getUint16(l),a>=65504&&65519>=a||65534===a)&&(n=s.getUint16(l+2)+2,
!(l+n>s.byteLength));){
if(i=t.parsers[a],!r&&i)for(u=0;u<i.length;u+=1)i[u].call(t,s,l,n,g);
l+=n,b=l;
}
...
var i=e("biz_web/lib/webuploader/base.js"),o=e("biz_web/lib/webuploader/uploader.js"),t=e("biz_web/lib/webuploader/lib/image.js");
e("biz_web/lib/webuploader/widgets/widget.js");
var r,n=i.$;
return r=function(e){
var i=0,o=[],t=function(){
...
var o,r,s=this.options.compress||this.options.resize,a=s&&s.compressSize||0,l=s&&s.noCompressIfLarger||!1;
...
var t=e("biz_web/lib/webuploader/base.js"),n=e("biz_web/lib/webuploader/runtime/client.js"),o=e("biz_web/lib/webuploader/lib/file.js"),r=e("biz_web/lib/webuploader/lib/image.js"),s=t.$;
return i.options={
button:null,
container:null,
label:null,
...
refresh:function(){
var e=this.getRuntime().getContainer(),i=this.options.button,t=i.outerWidth?i.outerWidth():i.width(),n=i.outerHeight?i.outerHeight():i.height(),o=i.offset();
