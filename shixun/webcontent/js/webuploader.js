...
define("biz_web/lib/webuploader/base.js", ["biz_web/lib/webuploader/promise.js"], function(r) {
	...
	var o = r("biz_web/lib/webuploader/promise.js"),
		i = function() {},
		a = Function.call;
	return {
		version: "@version@",
		...
		browser: function(r) {
			var t = {},
				e = r.match(/WebKit\/([\d.]+)/),
				n = r.match(/Chrome\/([\d.]+)/) || r.match(/CriOS\/([\d.]+)/),
				o = r.match(/MSIE\s([\d\.]+)/) || r.match(/(?:trident)(?:.*rv:([\w.]+))?/i),
				i = r.match(/Firefox\/([\d.]+)/),
				a = r.match(/Safari\/([\d.]+)/),
				u = r.match(/OPR\/([\d.]+)/);
		...
		os: function(r) {
			var t = {},
				...
				n = r.match(/(?:iPad|iPod|iPhone).*OS\s([\d_]+)/);
...
define("biz_web/lib/webuploader/mediator.js", ["biz_web/lib/webuploader/base.js"], function(t) {
	...
	function i(t, n) {
		for (var e, i = !1, r = -1, s = t.length; ++r < s;)
			if (e = t[r], e.cb.apply(e.ctx2, n) === !1) {
				i = !0;
				break;
			}
		return !i;
	}
	var r, s = t("biz_web/lib/webuploader/base.js"),
		u = s.$,
		c = [].slice,
		o = /\s+/;
	return r = {
...
define("biz_web/lib/webuploader/runtime/runtime.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/mediator.js"], function(e) {
	...
	var n = e("biz_web/lib/webuploader/base.js"),
		i = e("biz_web/lib/webuploader/mediator.js"),
		r = n.$,
		o = {},
		a = function(e) {
			for (var t in e)
...
define("biz_web/lib/webuploader/runtime/flash/runtime.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/runtime.js", "biz_web/lib/webuploader/runtime/compbase.js"], function(e) {
	...
	function i() {
		...
		s.apply(n, arguments), n.type = u, n.exec = function(e, s) {
			...
			var i = n.getFlash(),
				s = a.slice(arguments, 2);
			return i.exec(this.uid, e, t, s);
		};
	}
	var a = e("biz_web/lib/webuploader/base.js"),
		s = e("biz_web/lib/webuploader/runtime/runtime.js"),
		r = e("biz_web/lib/webuploader/runtime/compbase.js"),
		n = a.$,
		u = "flash",
		l = {};
	return a.inherits(s, {
...
define("biz_web/lib/webuploader/runtime/client.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/mediator.js", "biz_web/lib/webuploader/runtime/runtime.js"], function(e) {
	...
	var i, n = e("biz_web/lib/webuploader/base.js"),
		r = e("biz_web/lib/webuploader/mediator.js"),
		o = e("biz_web/lib/webuploader/runtime/runtime.js");
	return i = function() {
		var e = {};
		return {
			add: function(t) {
			...
			get: function(t, i) {
				...
				if (t) return e[t];
				for (n in e)
					if (!i || !e[n].__standalone) return e[n];
				return null;
			},
			remove: function(t) {
				delete e[t.uid];
...
define("biz_web/lib/webuploader/lib/blob.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/client.js"], function(e) {
	...
	var t = e("biz_web/lib/webuploader/base.js"),
		b = e("biz_web/lib/webuploader/runtime/client.js");
	return t.inherits(b, {
		constructor: i,
		slice: function(e, i) {
...
define("biz_web/lib/webuploader/runtime/flash/blob.js", ["biz_web/lib/webuploader/runtime/flash/runtime.js", "biz_web/lib/webuploader/lib/blob.js"], function(b) {
	var e = b("biz_web/lib/webuploader/runtime/flash/runtime.js"),
		i = b("biz_web/lib/webuploader/lib/blob.js");
...
define("biz_web/lib/webuploader/runtime/flash/transport.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/flash/runtime.js", "biz_web/lib/webuploader/runtime/client.js"], function(e) {
	var t = e("biz_web/lib/webuploader/base.js"),
		r = e("biz_web/lib/webuploader/runtime/flash/runtime.js"),
		n = e("biz_web/lib/webuploader/runtime/client.js"),
		s = t.$;
	return r.register("Transport", {
		...
		send: function() {
			var e, t = this.owner,
				...
				o = t._blob,
				i = r.server;
			n.connectRuntime(o.ruid), r.sendAsBinary ? (i += (/\?/.test(i) ? "&" : "?") + s.param(t._formData),
					e = o.uid) : (s.each(t._formData, function(e, t) {
					n.exec("append", e, t);
				}), n.exec("appendBlob", r.fileVal, o.uid, r.filename || t._formData.name || "")), this._setRequestHeader(n, r.headers),
				n.exec("send", {
					method: r.method,
					url: i,
...
define("biz_web/lib/webuploader/runtime/flash/filepicker.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/flash/runtime.js"], function(e) {
	var i = e("biz_web/lib/webuploader/base.js"),
		t = e("biz_web/lib/webuploader/runtime/flash/runtime.js"),
		l = i.$;
...
define("biz_web/lib/webuploader/runtime/html5/runtime.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/runtime.js", "biz_web/lib/webuploader/runtime/compbase.js"], function(e) {
	function i() {
		...
		t.apply(i, arguments), i.type = b, i.exec = function(t, n) {
			var b, a = this,
				s = a.uid,
				o = r.slice(arguments, 2);
			return u[t] && (b = e[s] = e[s] || new u[t](a, i), b[n]) ? b[n].apply(b, o) : void 0;
		}, i.destroy = function() {
			return n && n.apply(this, arguments);
		};
	}
	var r = e("biz_web/lib/webuploader/base.js"),
		t = e("biz_web/lib/webuploader/runtime/runtime.js"),
		n = e("biz_web/lib/webuploader/runtime/compbase.js"),
		b = "html5",
		u = {};
	return r.inherits(t, {
		constructor: i,
...
define("biz_web/lib/webuploader/runtime/html5/util.js", ["biz_web/lib/webuploader/base.js"], function(e) {
	var t = e("biz_web/lib/webuploader/base.js"),
		r = window.createObjectURL && window || window.URL && URL.revokeObjectURL && URL || window.webkitURL,
		n = t.noop,
		a = n;
	return r && (n = function() {
...
define("biz_web/lib/webuploader/runtime/html5/image.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/html5/runtime.js", "biz_web/lib/webuploader/runtime/html5/util.js"], function(t) {
	var e = t("biz_web/lib/webuploader/base.js"),
		a = t("biz_web/lib/webuploader/runtime/html5/runtime.js"),
		i = t("biz_web/lib/webuploader/runtime/html5/util.js"),
		r = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D";
	return a.register("Image", {
		...
		init: function() {
			...
			e.onload = function() {
				t._info = {
					...
					t._metas = a, t.owner.trigger("load");
				});
			}, e.onerror = function() {
		...
		getAsBlob: function(t) {
			...
			if (t = t || this.type, this.modified || this.type !== t) {
				if (e = this._canvas, "image/jpeg" === t) {
					if (a = i.canvasToDataUrl(e, t, r.quality), r.preserveHeaders && this._metas && this._metas.imageHead) return a = i.dataURL2ArrayBuffer(a),
						a = i.updateImageHead(a, this._metas.imageHead), a = i.arrayBufferToBlob(a, t);
				} else a = i.canvasToDataUrl(e, t);
				a = i.dataURL2Blob(a);
			}
			return a;
		},
		...
		_renderImageToCanvas: function() {
			function t(t, e, a) {
				var i, r, n, s = document.createElement("canvas"),
					o = s.getContext("2d"),
					h = 0,
					l = a,
					c = a;
			...
			return e.os.ios ? e.os.ios >= 7 ? function(e, a, i, r, n, s) {
				...
				var h, l, c, g, d, u, m, b = i.naturalWidth,
					...
					A = 0,
					I = 0;
				for (w && (b /= 2, _ /= 2), f.save(), h = document.createElement("canvas"), h.width = h.height = p,
					l = h.getContext("2d"), c = v ? t(i, b, _) : 1, g = Math.ceil(p * s / b), d = Math.ceil(p * o / _ / c); _ > A;) {
					for (u = 0, m = 0; b > u;) l.clearRect(0, 0, p, p), l.drawImage(i, -u, -A), f.drawImage(h, 0, 0, p, p, r + m, n + I, g, d),
						u += p, m += g;
					A += p, I += d;
				}
				f.restore(), h = l = null;
...
define("biz_web/lib/webuploader/runtime/html5/transport.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/html5/runtime.js"], function(e) {
	var t = e("biz_web/lib/webuploader/base.js"),
		r = e("biz_web/lib/webuploader/runtime/html5/runtime.js"),
		n = t.noop,
		s = t.$;
	return r.register("Transport", {
		init: function() {
		...
		send: function() {
			var e, r, n, a = this.owner,
				o = this.options,
				i = this._initAjax(),
				u = a._blob,
				d = o.server;
			o.sendAsBinary ? (d += (/\?/.test(d) ? "&" : "?") + s.param(a._formData), r = u.getSource()) : (e = new FormData,
				s.each(a._formData, function(t, r) {
					e.append(t, r);
				}), e.append(o.fileVal, u.getSource(), o.filename || a._formData.name || "")), o.withCredentials && "withCredentials" in i ? (i.open(o.method, d, !0),
				i.withCredentials = !0) : i.open(o.method, d), this._setRequestHeader(i, o.headers), r ? (i.overrideMimeType && i.overrideMimeType("application/octet-stream"),
				t.os.android ? (n = new FileReader, n.onload = function() {
					i.send(this.result), n = n.onload = null;
				}, n.readAsArrayBuffer(r)) : i.send(r)) : i.send(e);
		},
		getResponse: function() {
			return this._response;
		},
		...
		_initAjax: function() {
			...
			return !r.withCredentials || "withCredentials" in t || "undefined" == typeof XDomainRequest || (t = new XDomainRequest),
				t.upload.onprogress = function(t) {
					...
					return 4 === t.readyState ? (t.upload.onprogress = n, t.onreadystatechange = n, e._xhr = null,
...
define("biz_web/lib/webuploader/runtime/html5/imagemeta.js", ["biz_web/lib/webuploader/runtime/html5/util.js"], function(e) {
	var t, r = e("biz_web/lib/webuploader/runtime/html5/util.js");
	return t = {
		parsers: {
			65505: []
		},
		...
		parse: function(e, t) {
			var r = this,
				a = new FileReader;
			a.onload = function() {
				t(!1, r._parse(this.result)), a = a.onload = a.onerror = null;
			}, a.onerror = function(e) {
				t(e.message), a = a.onload = a.onerror = null;
			}, e = e.slice(0, r.maxMetaDataSize), a.readAsArrayBuffer(e.getSource());
		},
		_parse: function(e, r) {
			if (!(e.byteLength < 6)) {
				var a, n, i, u, s = new DataView(e),
					l = 2,
					o = s.byteLength - 4,
					b = l,
					g = {};
				if (65496 === s.getUint16(0)) {
					for (; o > l && (a = s.getUint16(l), a >= 65504 && 65519 >= a || 65534 === a) && (n = s.getUint16(l + 2) + 2, !(l + n > s.byteLength));) {
						if (i = t.parsers[a], !r && i)
							for (u = 0; u < i.length; u += 1) i[u].call(t, s, l, n, g);
						l += n, b = l;
					}
					b > 6 && (g.imageHead = e.slice ? e.slice(2, b) : new Uint8Array(e).subarray(2, b));
				}
				return g;
			}
		},
		updateImageHead: function(e, t) {
			var r, a, n, i = this._parse(e, !0);
			return n = 2, i.imageHead && (n = 2 + i.imageHead.byteLength), a = e.slice ? e.slice(n) : new Uint8Array(e).subarray(n),
				r = new Uint8Array(t.byteLength + 2 + a.byteLength), r[0] = 255, r[1] = 216, r.set(new Uint8Array(t), 2),
				r.set(new Uint8Array(a), t.byteLength + 2), r.buffer;
		}
	}, r.parseMeta = function() {
		return t.parse.apply(t, arguments);
	}, r.updateImageHead = function() {
...
define("biz_web/lib/webuploader/runtime/html5/imagemeta/exif.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/html5/imagemeta.js"], function(e) {
	var t = e("biz_web/lib/webuploader/base.js"),
		i = e("biz_web/lib/webuploader/runtime/html5/imagemeta.js"),
		n = {};
...
define("biz_web/lib/webuploader/runtime/html5/filepicker.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/html5/runtime.js", "biz_web/lib/webuploader/runtime/html5/util.js"], function(e) {
	var t = e("biz_web/lib/webuploader/base.js"),
		i = e("biz_web/lib/webuploader/runtime/html5/runtime.js"),
		n = (e("biz_web/lib/webuploader/runtime/html5/util.js"),
			t.$);
	return i.register("FilePicker", {
		init: function() {
			var e, t, i, l, r = this.getRuntime().getContainer(),
				a = this,
				o = a.owner,
				u = a.options,
				s = this.label = n(document.createElement("label")),
				c = this.input = n(document.createElement("input"));
...
define("biz_web/lib/webuploader/runtime/html5/blob.js", ["biz_web/lib/webuploader/runtime/html5/runtime.js", "biz_web/lib/webuploader/lib/blob.js"], function(e) {
	var b = e("biz_web/lib/webuploader/runtime/html5/runtime.js"),
		i = e("biz_web/lib/webuploader/lib/blob.js");
	return b.register("Blob", {
		slice: function(e, b) {
			var l = this.owner.source,
				r = l.slice || l.webkitSlice || l.mozSlice;
...
define("biz_web/lib/webuploader/uploader.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/mediator.js"], function(e) {
	...
	var i = e("biz_web/lib/webuploader/base.js"),
		s = e("biz_web/lib/webuploader/mediator.js"),
		n = i.$;
...
define("biz_web/lib/webuploader/lib/image.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/client.js", "biz_web/lib/webuploader/lib/blob.js"], function(e) {
	...
	var t = e("biz_web/lib/webuploader/base.js"),
		n = e("biz_web/lib/webuploader/runtime/client.js"),
		o = e("biz_web/lib/webuploader/lib/blob.js"),
		s = t.$;
	return i.options = {
		quality: 90,
		crop: !1,
		...
		getAsBlob: function(e) {
			var i = this.exec("getAsBlob", e);
			return new o(this.getRuid(), i);
		}
	}), i;
});;
define("biz_web/lib/webuploader/widgets/widget.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/uploader.js"], function(e) {
	...
	var i = e("biz_web/lib/webuploader/base.js"),
		r = e("biz_web/lib/webuploader/uploader.js"),
		o = i.$,
		s = r.prototype._init,
		u = r.prototype.destroy,
		p = {},
		a = [];
	return o.extend(t.prototype, {
		...
		if (e && "anonymous" !== e)
			for (var n = a.length; n--;) a[n]._name === e && a.splice(n, 1);
	}, t;
});;
define("biz_web/lib/webuploader/widgets/image.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/uploader.js", "biz_web/lib/webuploader/lib/image.js", "biz_web/lib/webuploader/widgets/widget.js"], function(e) {
	var i = e("biz_web/lib/webuploader/base.js"),
		o = e("biz_web/lib/webuploader/uploader.js"),
		t = e("biz_web/lib/webuploader/lib/image.js");
	...
	return r = function(e) {
		var i = 0,
			o = [],
			t = function() {
				for (var t; o.length && e > i;) t = o.shift(), i += t[0], t[1]();
			};
		return function(e, r, n) {
			o.push([r, n]), e.once("destroy", function() {
				i -= r, setTimeout(t, 1);
			}), setTimeout(t, 1);
		};
		...
		name: "image",
		makeThumb: function(e, i, o, s) {
			var a, l;
			return e = this.request("get-file", e), e.type.match(/^image/) ? (a = n.extend({}, this.options.thumb),
				n.isPlainObject(o) && (a = n.extend(a, o), o = null), o = o || a.width, s = s || a.height, l = new t(a),
				l.once("load", function() {
					e._info = e._info || l.info(), e._meta = e._meta || l.meta(), 1 >= o && o > 0 && (o = e._info.width * o),
						1 >= s && s > 0 && (s = e._info.height * s), l.resize(o, s);
		...
		beforeSendFile: function(e) {
			var o, r, s = this.options.compress || this.options.resize,
				a = s && s.compressSize || 0,
				l = s && s.noCompressIfLarger || !1;
			return e = this.request("get-file", e), !s || !~"image/jpeg,image/jpg".indexOf(e.type) || e.size < a || e._compressed ? void 0 : (s = n.extend({}, s),
				r = i.Deferred(), o = new t(s), r.always(function() {
					o.destroy(), o = null;
				}), o.once("error", r.reject), o.once("load", function() {
					var i = s.width,
						t = s.height;
					e._info = e._info || o.info(), e._meta = e._meta || o.meta(), 1 >= i && i > 0 && (i = e._info.width * i),
						1 >= t && t > 0 && (t = e._info.height * t), o.resize(i, t);
				}), o.once("complete", function() {
					var i, t;
					try {
						i = o.getAsBlob(s.type), t = e.size, (!l || i.size < t) && (e.source = i, e.size = i.size, e.trigger("resize", i.size, t)),
							e._compressed = !0, r.resolve();
					} catch (n) {
						r.resolve();
					}
...
define("biz_web/lib/webuploader/file.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/mediator.js"], function(t) {
	...
	var s = t("biz_web/lib/webuploader/base.js"),
		n = t("biz_web/lib/webuploader/mediator.js"),
		a = s.$,
		o = "WU_FILE_",
		r = 0,
		u = /\.([^.]+)$/,
...
define("biz_web/lib/webuploader/widgets/validator.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/uploader.js", "biz_web/lib/webuploader/file.js", "biz_web/lib/webuploader/widgets/widget.js"], function(e) {
	var i = e("biz_web/lib/webuploader/base.js"),
		t = e("biz_web/lib/webuploader/uploader.js"),
		n = e("biz_web/lib/webuploader/file.js");
	e("biz_web/lib/webuploader/widgets/widget.js");
	var o, r = i.$,
		u = {};
	return o = {
...
define("biz_web/lib/webuploader/lib/transport.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/client.js", "biz_web/lib/webuploader/mediator.js"], function(e) {
	...
	var i = e("biz_web/lib/webuploader/base.js"),
		o = e("biz_web/lib/webuploader/runtime/client.js"),
		n = e("biz_web/lib/webuploader/mediator.js"),
		s = i.$;
	return t.options = {
		server: "",
		method: "POST",
...
define("biz_web/lib/webuploader/widgets/upload.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/uploader.js", "biz_web/lib/webuploader/file.js", "biz_web/lib/webuploader/lib/transport.js", "biz_web/lib/webuploader/widgets/widget.js"], function(t) {
	...
	var i = t("biz_web/lib/webuploader/base.js"),
		r = t("biz_web/lib/webuploader/uploader.js"),
		n = t("biz_web/lib/webuploader/file.js"),
		s = t("biz_web/lib/webuploader/lib/transport.js");
	...
	o.extend(r.options, {
		...
		startUpload: function(t) {
			...
			if (o.each(e.request("get-files", u.INVALID), function() {
				...
				if (t = t.id ? t : e.request("get-file", t), t.getStatus() === u.INTERRUPT) o.each(e.pool, function(e, i) {
		...
		_prepareNextFile: function() {
			...
			i && (t = e.request("before-send-file", i, function() {
				...
				i.setStatus(u.ERROR, t), e.owner.trigger("uploadError", i, t), e.owner.trigger("uploadComplete", i);
			}), r.push(t));
		},
		...
		_doSend: function(t) {
			var e, r, n = this,
				...
				p = t.file,
				c = new s(l),
				d = o.extend({}, l.formData),
				f = o.extend({}, l.headers);
...
define("biz_web/lib/webuploader/widgets/runtime.js", ["biz_web/lib/webuploader/uploader.js", "biz_web/lib/webuploader/runtime/runtime.js", "biz_web/lib/webuploader/widgets/widget.js"], function(e) {
	var i = e("biz_web/lib/webuploader/uploader.js"),
		r = e("biz_web/lib/webuploader/runtime/runtime.js");
	return e("biz_web/lib/webuploader/widgets/widget.js"), i.support = function() {
		...
		predictRuntimeType: function() {
			var e, i, t = this.options.runtimeOrder || r.orders,
				u = this.type;
			if (!u)
				for (t = t.split(/\s*,\s*/g), e = 0, i = t.length; i > e; e++)
					if (r.hasRuntime(t[e])) {
						this.type = u = t[e];
						break;
					}
...
define("biz_web/lib/webuploader/lib/file.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/lib/blob.js"], function(e) {
	...
	var b = e("biz_web/lib/webuploader/base.js"),
		t = e("biz_web/lib/webuploader/lib/blob.js"),
		a = 1,
		l = /\.([^.]+)$/;
...
define("biz_web/lib/webuploader/queue.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/mediator.js", "biz_web/lib/webuploader/file.js"], function(e) {
	...
	var u = e("biz_web/lib/webuploader/base.js"),
		n = e("biz_web/lib/webuploader/mediator.js"),
		i = e("biz_web/lib/webuploader/file.js"),
		s = u.$,
		a = i.Status;
	return s.extend(t.prototype, {
		...
		fetch: function(e) {
			...
			for (e = e || a.QUEUED, t = 0; n > t; t++)
				if (u = this._queue[t], e === u.getStatus()) return u;
			return null;
		},
		sort: function(e) {
		...
		getFiles: function() {
			for (var e, t = [].slice.call(arguments, 0), u = [], n = 0, i = this._queue.length; i > n; n++) e = this._queue[n], (!t.length || ~s.inArray(e.getStatus(), t)) && u.push(e);
			return u;
		},
...
define("biz_web/lib/webuploader/widgets/queue.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/uploader.js", "biz_web/lib/webuploader/queue.js", "biz_web/lib/webuploader/file.js", "biz_web/lib/webuploader/lib/file.js", "biz_web/lib/webuploader/runtime/client.js", "biz_web/lib/webuploader/widgets/widget.js"], function(e) {
	var t = e("biz_web/lib/webuploader/base.js"),
		i = e("biz_web/lib/webuploader/uploader.js"),
		r = e("biz_web/lib/webuploader/queue.js"),
		u = e("biz_web/lib/webuploader/file.js"),
		s = e("biz_web/lib/webuploader/lib/file.js"),
		n = e("biz_web/lib/webuploader/runtime/client.js");
	e("biz_web/lib/webuploader/widgets/widget.js");
	var l = t.$,
		a = /\.\w+$/,
	...
	return i.register({
		...
		retry: function(e, t) {
			var i, r, u, s = this;
			if (e) return e = e.id ? e : s.queue.getFile(e), e.setStatus(o.QUEUED), void(t || s.request("start-upload"));
			for (i = s.queue.getFiles(o.ERROR), r = 0, u = i.length; u > r; r++) e = i[r], e.setStatus(o.QUEUED);
...
define("biz_web/lib/webuploader/lib/filepicker.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/runtime/client.js", "biz_web/lib/webuploader/lib/file.js", "biz_web/lib/webuploader/lib/image.js"], function(e) {
	...
	var t = e("biz_web/lib/webuploader/base.js"),
		n = e("biz_web/lib/webuploader/runtime/client.js"),
		o = e("biz_web/lib/webuploader/lib/file.js"),
		r = e("biz_web/lib/webuploader/lib/image.js"),
		s = t.$;
	return i.options = {
		button: null,
		container: null,
				...
				switch (t) {
					...
					case "change":
						l = e.exec("getFiles"), a = 0, l = s.map(l, function(t) {
							if (t = new o(e.getRuid(), t), t._refer = i.container, i.imageSize && ~"image/jpeg,image/jpg,image/png,image/bmp,image/gif".indexOf(t.type)) {
								var n = new r(i.compress || i.resize);
								n.on("load", function() {
									var o = n.info();
									t.width = o.width, t.height = o.height, a++, a == l.length && e.trigger("select", l, i.container);
								}), n.on("error", function() {
		...
		refresh: function() {
			var e = this.getRuntime().getContainer(),
				i = this.options.button,
				t = i.outerWidth ? i.outerWidth() : i.width(),
				n = i.outerHeight ? i.outerHeight() : i.height(),
				o = i.offset();
			i.is(":visible") || (t += parseInt(i.css("min-width")) || 0), t && n && e.css({
				bottom: "auto",
				right: "auto",
				width: t + "px",
				height: n + "px"
...
define("biz_web/lib/webuploader/widgets/filepicker.js", ["biz_web/lib/webuploader/base.js", "biz_web/lib/webuploader/uploader.js", "biz_web/lib/webuploader/lib/filepicker.js", "biz_web/lib/webuploader/widgets/widget.js"], function(e) {
	var i = e("biz_web/lib/webuploader/base.js"),
		t = e("biz_web/lib/webuploader/uploader.js"),
		n = e("biz_web/lib/webuploader/lib/filepicker.js");
	e("biz_web/lib/webuploader/widgets/widget.js");
	var r = i.$;
