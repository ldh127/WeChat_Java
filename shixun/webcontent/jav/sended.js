...
define("tpl/media/multiple_appmsg.html.js", [], function() {
	return '<div class="appmsgSendedItem multiple_appmsg">\n    {each multi_item as item index}\n    <div class="appsmg_item">\n    {if item.content_url}\n    <a class="title_wrp" href="{item.content_url}" target="_blank">\n    {else}\n    <div class="title_wrp">\n    {/if}\n        {if index==0}<img class="icon icon_lh" src="{appmsg_cover}">{/if}\n        <span class="title  {if item.is_deleted == 1}deleted{/if}" >[{type_msg}{item.seq}]{item.title}</span>\n    {if item.content_url}\n    </a>\n    {else}\n    </div>\n    {/if}\n    {if item.copyright_status == 11}<span class="icon_tag_gray">原创</span><a href=\'/cgi-bin/appmsgcopyright?action=reprint&begin=0&count=10&id={item.msg_id}&idx={item.seq}{param}\' target=\'_blank\'>转载详情</a>{/if}\n    \n    {if item.vote_id.length == 1}\n    <p class="desc"><i class="icon_vote"></i><a href="javascript:void(0);" class="js_view_vote" data-id="{id}">查看结果</a></p>\n    {/if}\n    {if item.super_vote_id && item.super_vote_id.length == 1}\n    <p class="desc"><i class="icon_vote"></i><a href="javascript:void(0);" class="js_view_vote" data-superVoteId="{item.super_vote_id[0]}" data-id="{id}">查看结果</a></p>\n    {/if}\n    </div>\n    {/each}\n    {if (show_type == 0 && !!app_name) }\n    <div class="resource appmsgFrom">来自{app_name}</div>\n    {/if}\n</div>\n';
});
...
define("common/wx/media/multipleAppmsg.js", ["tpl/media/multiple_appmsg.html.js", "widget/media.css", "common/qq/Class.js"], function(t) {
	"use strict";
	var i = (wx.T, t("tpl/media/multiple_appmsg.html.js")),
		e = (t("widget/media.css"), t("common/qq/Class.js")),
		s = wx.url("/cgi-bin/getimgdata"),
		m = {
			9: {
				1: "图文消息",
				2: "图文消息",
...
define("tpl/media/card_ticket.html.js", [], function() {
	return '<div class="appmsgSendedItem card_ticket">\n    <div class="title_wrp" href="/merchant/electroniccardmgr?action=detail&t=cardticket/detail&cardid={id}&lang=zh_CN&token={token}" target="_blank">\n        <span class="icon"></span>\n        <span class="title">[卡券]{title}</span>\n    </div>\n    <p class="desc">{brand_name}</p>\n</div>';
});
...
define("mass/list.js", ["common/qq/emoji.js", "common/wx/popup.js", "common/qq/mask.js", "common/wx/pagebar.js", "common/wx/Tips.js", "common/wx/time.js", "common/wx/media/img.js", "common/wx/media/audio.js", "common/wx/media/video.js", "tpl/media/card_ticket.html.js", "tpl/media/word.html.js", "cardticket/parse_data.js", "common/wx/media/idCard.js", "common/wx/media/simpleAppmsg.js", "common/wx/media/multipleAppmsg.js", "message/message_cgi.js", "common/wx/tooltips.js", "common/wx/Cgi.js", "biz_common/moment.js", "common/wx/top.js", "biz_web/ui/checkbox.js", "common/wx/popover.js"], function(t) {
	"use strict";
	t("common/qq/emoji.js"), t("common/wx/popup.js");
	var e = wx.cgiData,
		s = (t("common/qq/mask.js"), t("common/wx/pagebar.js")),
		i = t("common/wx/Tips.js"),
		a = t("common/wx/time.js"),
		o = a.timeFormat,
		n = t("common/wx/media/img.js"),
		c = t("common/wx/media/audio.js"),
		m = t("common/wx/media/video.js"),
		r = t("tpl/media/card_ticket.html.js"),
		d = t("tpl/media/word.html.js"),
		l = t("cardticket/parse_data.js"),
		p = t("common/wx/media/idCard.js"),
		u = t("common/wx/media/simpleAppmsg.js"),
		_ = t("common/wx/media/multipleAppmsg.js"),
		f = t("message/message_cgi.js"),
		v = t("common/wx/tooltips.js"),
		h = t("common/wx/Cgi.js"),
		g = t("biz_common/moment.js"),
		w = t("common/wx/top.js");
	t("biz_web/ui/checkbox.js"), new w("#topTab", w.DATA.mass).selected(1),
		function() {
			function s(t) {
				var e = t.msg_status,
					s = t.send_stat.progress,
					i = "发送失败";
				switch (e) {
					case 1:
					case 101:
			...
			function a() {
				var t = $(this),
					...
					i = y[e];
				if (i) {
					i.multi_item && i.multi_item.each(function(t) {
						t.is_deleted && (i.is_deleted = !0);
					});
					var o = template.render("js_massResult", i);
					$(".js_" + e).remove(), new v({
						container: this,
						content: o,
						parentClass: "js_" + e,
						...
						h.get({
							...
							0 == e.base_resp.ret && (i.msg_status = e.msg_status, i.send_stat = e.send_stat || i.send_stat,
								$("#massItem" + i.id).find(".js_status").html(s(i) + '<i class="icon_arrow_down"></i>'),
								a.call(t), 2 == i.msg_status && 1 == i.multi_item.length && $("#massItem" + i.id).find(".mass_opr").html(wx.T('<a class="js_del" data-id="{id}" data-type="{type}" href="javascript:void(0);">删除</a>', i)));
						});
					}, 1e4);
				}
			}
			...
			function w(t, e) {
				t = $(t), e = e || 0;
				var s = t.data("id"),
					a = t.data("supervoteid");
				if (!s) return !1;
				if (a) return window.location = wx.url("/cgi-bin/newoperatevote?action=show&supervoteid=" + a), !0;
				var o = "#7DB985 #7DADE1 #ECCC63 #EC9062 #DF7370 #DF70A6".split(" "),
					n = y[s].voteIds;
				h.get({
					url: wx.url("/cgi-bin/operate_vote?action=show&voteid=%s".sprintf(n[e])),
					mask: !1,
					handlerTimeout: !0,
					error: function() {
						i.err("获取失败");
					...
					if (s && s.base_resp && 0 == s.base_resp.ret) {
						...
						$(i).each(function(t, e) {
							...
							c.push({
								color: o[t],
								name: e.name,
								percent: 0 == n ? 0 : Math.ceil(100 * e.count / n),
								num: e.count
							});
						});
						var m = template.render("jsVoteResultPop", {
								vote_prev_show: !1,
								vote_next_show: !1,
								vote_title: s.title,
								vote_start_date: g.unix(s.create_time).format("YYYY/MM/DD HH:mm"),
								vote_end_date: g.unix(s.expire_time).format("YYYY/MM/DD HH:mm"),
								vote_person: a,
								vote_options: c
							}).trim(),
							r = $(m).popup({
						...
						r.find(".js_vote_prev").click(function() {
							r.find(".pop_closed").click(), w(t, e - 1);
						}), r.find(".js_vote_next").click(function() {
							r.find(".pop_closed").click(), w(t, e + 1);
						});
					}
				});
			...
			var j = e.list,
				...
				k = {
					1: function(t, e) {
						t.html(template.compile(d)({
							content: e.content.emoji().replace(/(\\n)/g, "").replace(/(\\\\)/g, "\\")
						}));
					},
					2: function(t, e) {
						return new n({
					...
					3: function(t, e) {
						var s = e;
						return s.selector = "#" + t.attr("id"), new c(s);
					},
					4: function(t, e) {
						var s = e;
						return s.selector = "#" + t.attr("id"), new m(s);
					},
					42: function(t, e) {
						var s = e;
						return s.container = "#" + t.attr("id"), new p(s);
					},
					10: function(t, e) {
						var s = e;
						return s.container = "#" + t.attr("id"), s.param = wx.data.param, 1 == s.multi_item.length ? new u(s) : s.multi_item.length > 1 ? new _(s) : void 0;
					},
					15: function(t, e) {
						var s = $.extend({}, e);
						return s.sent = !0, s.selector = t, s.tpl = "videomsg", s.id = 1e5 * Math.random() | 0, new m(s);
					},
					17: function(t, e) {
						var s = l.parse_cardticket(e.card);
						s && (s.token = wx.data.t, t.html(template.compile(r)(s)));
					}
				};
			k[16] = k[15], k[62] = k[4], k[9] = k[10], k[11] = k[10];
			for (var b, y = {}, D = 0; x > D; D++) {
				b = j[D], console.log(b);
				var q = b.multi_item,
					C = [];
				if (q.length)
					for (var A = 0; A < q.length; A++) C = C.concat(q[A].vote_id);
				if (b.voteIds = C, b.original_success = 0, b.original_fail = 0, b.original_apply = 0, q.length)
					for (var A = 0; A < q.length; A++) 1 == q[A].copyright_type && b.original_apply++,
						11 == q[A].copyright_status && b.original_success++, (12 == q[A].copyright_status || 13 == q[A].copyright_status) && b.original_fail++;
				y[b.id] = b, C.length > 0 && (b.hasVote = !0);
			}
			template.helper("timeFormat", function(t) {
				return o(t);
			}), template.helper("massStatus", s), template.helper("massDesc", function(t) {
				var e = t.msg_status,
					s = "";
				if (6 == e) {
					var i = t.refuse_reason;
					switch (i) {
						case "10001":
							s = "垃圾广告或骚扰";
							break;
				...
				var e = t,
					s = 0;
				e.multi_item && e.multi_item.each(function(t) {
					t.is_deleted && (e.is_deleted = !0, s++);
				}), s > 0 && s == e.multi_item.length && (e.msg_status = 7);
			});
			var I = $("#masslist").html(template.render("t_massList", {
				token: wx.data.t,
				list: j
			}).trim());
			$(".js_result", I).each(a), $(".mass_wrp", I).each(function() {
				var t = $(this),
					e = t.data("id"),
					s = y[e];
				if (s) {
			...
			I.on("click", ".js_del", function() {
				...
				var o = "确定删除？",
					n = !1;
				if ("9" != a && "17" != a) o = "确定删除？该操作只能删除历史消息中的记录，不能删除已经成功发送的消息。";
				else {
					var c = e.list[D];
					n = c.multi_item.length > 1, o = n ? template.render("msgDel", e.list[D]) : "确定删除？";
				}
				var m = new T({
					dom: this,
					content: o,
					...
					buttons: [{
						...
						click: function() {
							var e = "";
							return "9" == a && n && ($("input[type=checkbox][checked=checked]").each(function(t, s) {
								e += $(s).data("index") + 1 + ",";
							}), e = e.slice(0, -1), 0 == e.length) ? void this.remove() : (i.suc("正在删除"), f.massdel(s, function() {
								if (t.closest("td").empty(), n) window.location.reload();
								else {
									$("#massItem" + s).find(".js_status").html('已删除<i class="icon_arrow_down"></i>');
									var e = "<p>该消息已被你删除，你的粉丝在“查看历史消息”中将无法查看该消息</p>";
									"17" == a && (e = "<p>该消息已被你删除</p>"), $(".js_" + s).find(".popover_content").html(e);
								}
								$("#massItem" + s).find(".js_desc").html("");
							}, null, e), void this.remove());
						},
						type: "primary"
					}, {
						text: "取消",
				...
				m.$pop.css("left", m.$pop.position().left + 21 + "px"), $(".delCheck").checkbox();
			}), I.on("click", ".js_resend", function() {
				var t = $(this),
					e = t.data("id");
				new T({
					dom: this,
			...
			for (var Y = $(".mass_opr"), D = 0; x > D; ++D) 1 == j[D].can_retry_masssend && 5 == j[D].msg_status && (Y.eq(D).append('<a class="js_resend" href="javascript:void(0);">补发</a>'),
				Y.eq(D).find(".js_resend").attr("data-id", j[D].id));
			I.on("click", ".js_view_vote", function() {
					w($(this), 0);
				}),
				function() {
					var t = 1;
					$(".js_video").click(function() {
						var e = $(this).parent(),
							s = $(this),
							i = s.parents(".mass_wrp").data("id");
						t++, $("<div id='js_popup_video" + t + "'></div>").popup({
							title: e.find("span").html(),
							className: "dialog_video",
							onShow: function() {
								var e = this,
									s = $.extend({}, y[i]);
								s.selector = $("#js_popup_video" + t), s.sent = !1, s.tpl = "videomsg", s.title = "", s.time = "",
									s.from = "", s.digest = "", s.id = t, new m(s), setTimeout(function() {
										e.resetPosition();
									}, 100);
							},
							onHide: function() {
	...
	! function(t) {
		{
			...
			new s({
				...
				callback: function(t) {
					var e = t.currentPage;
					if (e != o) return e--, location.href = wx.url("/cgi-bin/masssendpage?t=mass/list&action=history&begin=%s&count=%s".sprintf(i * e, i)), !1;
				}
			});
		}
	}(j);
