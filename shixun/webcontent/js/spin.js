...
type: "POST"
}), e == "timeout" && i.err("浣犵殑缃戠粶鐜杈冨樊锛岃绋嶅悗閲嶈瘯");
};
} catch (s) {
wx.jslog({
...
return t===this.currentPage?!1:isNaN(t)?(h.err("璇疯緭鍏ユ纭殑椤电爜"),!1):""===t?!1:t<this.startPage?(h.err("璇疯緭鍏ユ纭殑椤电爜"),
!1):t>this.endPage?(h.err("璇疯緭鍏ユ纭殑椤电爜"),!1):(this.currentPage=t,void(this.callbackFunc("go")===!1&&(this.currentPage=e)));
},
...
return 9>t?"鏃╀笂":11>t&&30>e?"涓婂崍":13>t&&30>e?"涓崍":18>t?"涓嬪崍":"鏅氫笂";
},
calendar:{
sameDay:"[浠婂ぉ]LT",
nextDay:"[鏄庡ぉ]LT",
